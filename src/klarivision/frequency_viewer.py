...
timelineStyle.textContent='.panel{{height:calc(var(--chart-height) + 130px)}}.chart-scroll{{grid-template-rows:minmax(0,1fr)}}#time-scroll{{display:block!important;width:100%!important;height:18px!important;margin:7px 0 0!important;accent-color:#7755b8;flex:0 0 auto;visibility:visible!important;opacity:1!important}}.loop-controls{{display:flex;align-items:center;gap:7px;padding:4px 6px;border:1px solid #cbd7e2;border-radius:9px;background:#f4f8fc}}body.theme-studio{{background:#171b20;color:#edf4f8}}body.theme-studio .panel,body.theme-studio .workspace.audio-only .media{{background:#20262d;border-color:#3a4653}}body.theme-studio .tools button,body.theme-studio select{{background:#28323c;color:#edf4f8;border-color:#536271}}body.theme-studio .note,body.theme-studio p,body.theme-studio .legend{{color:#b9c6d2}}body.theme-studio .loop-controls{{background:#192d34;border-color:#38717a}}body.theme-classic{{background:#f7f0e5;color:#263647}}body.theme-classic .panel,body.theme-classic .workspace.audio-only .media{{background:#fffaf1;border-color:#d9bb82}}body.theme-classic .tools button,body.theme-classic select{{background:#fffaf1;color:#263647;border-color:#c7a66d}}body.theme-classic .loop-controls{{background:#fbefd8;border-color:#c7a66d}}';
