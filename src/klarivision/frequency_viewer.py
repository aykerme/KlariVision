...
scaleMode.onchange=()=>{{tonicInput.disabled=scaleMode.value==='turkish';updateMakamStatus();draw()}};tonicInput.onchange=()=>draw();playbackRateInput.onchange=()=>{{media.playbackRate=Number(playbackRateInput.value)||1}};
