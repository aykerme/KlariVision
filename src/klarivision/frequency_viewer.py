...
function showCountdown(value){{countdownRemaining=value;countdownStatus.textContent=value>0?`Başlıyor: ${{value}}`:'';if(countdownOverlay){{countdownOverlay.hidden=value<=0;countdownOverlay.firstElementChild.textContent=value>0?String(value):''}}}}
