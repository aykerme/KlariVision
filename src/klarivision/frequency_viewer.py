...
<p>Pitch eğrisi pYIN'in ölçtüğü fiziksel frekanstır (Hz). Sol eksen, seçilen dizinin frekans başvurusudur; ölçülen eğri değiştirilmez.</p>
...
<label>Eksen <select id="scale-mode"><option value="major">Majör</option><option value="minor">Minör</option><option value="nihavent">Nihavend</option></select></label>
