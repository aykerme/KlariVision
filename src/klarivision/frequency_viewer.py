...
<div id="workspace" class="workspace"><div id="media-panel" class="media">{media}<span class="resize-handle resize-right" data-resize="right"></span><span class="resize-handle resize-bottom" data-resize="bottom"></span><span class="resize-handle resize-corner" data-resize="corner"></span></div>
...
<label>Karar (duyulan) <select id="tonic"><option value="0">Do</option><option value="2">Re</option><option value="4">Mi</option><option value="5">Fa</option><option value="7">Sol</option><option value="9">La</option><option value="11">Si</option></select></label>
...
function applyLayout(){{workspace.className=`workspace ${{layoutMode.value}}`;requestAnimationFrame(resize)}}
