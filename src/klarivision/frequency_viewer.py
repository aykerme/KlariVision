...
VIEWER_VERSION = "0.4.3-koma-rehberi"
...
<label>Eksen <select id="scale-mode"><option value="major">Majör</option><option value="minor">Minör</option><option value="nihavent">Nihavend</option><option value="kurdi">Kürdi</option><option value="ussak">Uşşak</option><option value="turkish">Türk Müziği · Sol Klarnet</option></select></label>
...
function ussakNotes(){{const solClarinetTonic=Number(tonicInput.value),soundingTonic=(solClarinetTonic+7)%12;return notesForMode('ussak',[0,2,3,5,7,9,10],solClarinetTonic,soundingTonic)}}
